...
/*
 *       AP_MotorsTriTailsitter_tmp.cpp - ArduCopter motors library for a tailsitter
...
#include "AP_MotorsTriTailsitter_tmp.h"
...
// init
void AP_MotorsTriTailsitter_tmp::init(motor_frame_class frame_class, motor_frame_type frame_type)
{
...
/// Constructor
AP_MotorsTriTailsitter_tmp::AP_MotorsTriTailsitter_tmp(uint16_t loop_rate, uint16_t speed_hz) :
...
void AP_MotorsTriTailsitter_tmp::output_to_motors()
{
...
void AP_MotorsTriTailsitter_tmp::output_armed_stabilizing()
{
    _aileron = -_yaw_in;
    _elevator = _pitch_in;
    _rudder = _roll_in;
