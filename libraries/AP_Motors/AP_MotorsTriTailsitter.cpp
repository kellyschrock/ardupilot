...
/*
 *       AP_MotorsTriTailsitter.cpp - ArduCopter motors library
...
void AP_MotorsTriTailsitter::set_update_rate( uint16_t speed_hz )
{
...
void AP_MotorsTriTailsitter::enable()
{
...
void AP_MotorsTriTailsitter::output_to_motors()
{
    switch (_spool_mode) {
        case SHUT_DOWN:
            ...
            SRV_Channels::set_output_scaled(SRV_Channel::k_elevator, _pitch_radio_passthrough*AP_MOTORS_SERVO_INPUT_RANGE);
            SRV_Channels::set_output_scaled(SRV_Channel::k_aileron,   _yaw_radio_passthrough*AP_MOTORS_SERVO_INPUT_RANGE);
            SRV_Channels::set_output_scaled(SRV_Channel::k_elevon_left,  (_pitch_radio_passthrough + _yaw_radio_passthrough)*AP_MOTORS_SERVO_INPUT_RANGE);
            SRV_Channels::set_output_scaled(SRV_Channel::k_elevon_right, (_pitch_radio_passthrough - _yaw_radio_passthrough)*AP_MOTORS_SERVO_INPUT_RANGE);
            break;
        case SPIN_WHEN_ARMED:
            ...
            SRV_Channels::set_output_scaled(SRV_Channel::k_elevator, _pitch_radio_passthrough*AP_MOTORS_SERVO_INPUT_RANGE);
            SRV_Channels::set_output_scaled(SRV_Channel::k_aileron,   _yaw_radio_passthrough*AP_MOTORS_SERVO_INPUT_RANGE);
            SRV_Channels::set_output_scaled(SRV_Channel::k_elevon_left,  ((_pitch_radio_passthrough + _yaw_radio_passthrough) * (1.0f - _spin_up_ratio))*AP_MOTORS_SERVO_INPUT_RANGE);
            SRV_Channels::set_output_scaled(SRV_Channel::k_elevon_right, ((_pitch_radio_passthrough - _yaw_radio_passthrough) * (1.0f - _spin_up_ratio))*AP_MOTORS_SERVO_INPUT_RANGE);
            break;
        case SPOOL_UP:
...
uint16_t AP_MotorsTriTailsitter::get_motor_mask()
{
...
void AP_MotorsTriTailsitter::output_armed_stabilizing()
{
    ...
    _thrust_rear = constrain_float(_thrust_ratio*thrust_out, 0.0f, 1.0f) + _thrust_rear;
...
void AP_MotorsTriTailsitter::output_test(uint8_t motor_seq, int16_t pwm)
{
...
*/
void AP_MotorsTriTailsitter::thrust_compensation(void)
{
